        ...
        <div className="accordion" id="accordionExample" style={mystyle}>
          <div className="accordion-item" style={mystyle}>
            ...
            <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
              <div className="accordion-body">
                <strong>TextMania is a React application designed to provide various text manipulation features to the user.</strong> 
          ...
          <div className="accordion-item" style={mystyle}>
            <h2 className="accordion-header" id="headingTwo">
              <button
                className="accordion-button collapsed btnCustom"
                style={mystyle}
                type="button"
                data-bs-toggle="collapse"
            ...
            <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
              <div className="accordion-body">
                <strong>TextMania offers a range of features to enhance your text editing experience:</strong>
                <ul>
          ...
          <div className="accordion-item" style={mystyle}>
            ...
            <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
              <div className="accordion-body">
                <p><strong>Technical Details:</strong>Technologies used in this project to build.. (React, JavaScript, etc.)</p>
                <p></p>
                <ul>
                  {/* <li><a href="/blog/text-manipulation-tips" style={{ color: mystyle.color }}></a></li>
