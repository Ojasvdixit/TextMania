...
import SpeechRecognitionControl from './SpeechRecognitionControl';
  ...
  return (
    <>
      <div className='container' style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
        ...
        <SpeechRecognitionControl  onTranscriptUpdate={handleTranscriptUpdate} mode={props.mode}/>
      ...
      <div className="container my-3" style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
        ...
        <TextChecker mode={props.mode} showAlert={props.showAlert} />
